...
from frcnn_utils.region_proposal_network import RegionProposalNetwork
from frcnn_utils.faster_rcnn import FasterRCNN
from frcnn_utils.roi_module import RoIPooling2D
...
class FRCNN_VGG16(FasterRCNN):
    ...
    def __init__(self, n_fg_class=20, ratios=(0.5, 1, 2), anchor_scales=(8, 16, 32)):
        ...
        super(FRCNN_VGG16, self).__init__(extractor, rpn, head, )
